                ...
                Some(mut key) => {
                    ...
                    for mut skey in sub_keys {
                        ...
                        for skey2 in sub_keys2 {
                            ...
                            results.push(format!("ntuser_gpohistory\tGPO history has been found (DisplayName: \"{}\", FileSysPath: \"{}\", Link: \"{}\")\t{}\t{}\t{}", displayname, filesyspath, link, target, key_path, last_key_write_timestamp));
                        }
                    }
